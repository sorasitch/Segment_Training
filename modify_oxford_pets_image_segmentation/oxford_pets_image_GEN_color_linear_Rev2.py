...
if os.path.exists('oxford_gen_color_r2.h5') and os.path.isfile('oxford_gen_color_r2.h5') :
    pass
    # load
    model=keras.models.load_model('oxford_gen_color_r2.h5',compile=False)
    # model.summary()
    ...
    callbacks = [
        keras.callbacks.ModelCheckpoint("oxford_gen_color_r2.h5", save_best_only=True)
    ]
...
print(val_x[1].shape)
display(img1)
img1.save('./out/oxford_gen_color_r2_0.png')
img1 = PIL.ImageOps.autocontrast(keras.preprocessing.image.array_to_img(val_y[1]))
print(val_y[1].shape)
display(img1)
img1.save('./out/oxford_gen_color_r2_1.png')
...
def display_mask(i):
    ...
    for j in range(val_preds.shape[-1]):
        ...
        display(img)
        img.save('./out/oxford_gen_color_r2_3_%d.png'%(j))
...
display(img)
img.save('./out/oxford_gen_color_r2_4.png')
...
img = PIL.ImageOps.autocontrast(keras.preprocessing.image.array_to_img(val_preds[0]))
display(img)
img.save('./out/oxford_gen_color_r2_5.png')
